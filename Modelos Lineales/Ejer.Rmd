...
deviance(m1)
```
Sería equivalente a la suma de cuadrados residual de un modelo lineal; valores más altos indican peor ajuste
...
```
Entonces la proporción de las mujeres es 263% de la de los hombre en el partido laboyer
