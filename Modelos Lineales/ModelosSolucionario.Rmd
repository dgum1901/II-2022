...
4.10  Deje que la serie observada $x_t$ esté compuesta por una señal periódica y ruido, de modo que pueda escribirse como $x_t = \beta _1 cos(2\pi kt) + β2 sin(2π \omega kt) + \omega _t$, donde $\omega _t$ es un proceso de ruido blanco con varianza $\sigma ^2 _\omega$. Se supone que la frecuencia $\omega _k$ es conocida y de la forma k/n en este problema. Supongamos que consideramos estimar $\beta _1, \beta _2$ y $\sigma ^2 _\omega$ por mínimos cuadrados o, de manera equivalente, por máxima verosimilitud si se supone que $\omega _t$ es gaussiana.
