...
\item $sqftliving:$ Superficie habitable.
\item $sqftlot:$ Tamaño del lote.
...
\item $sqftabove:$ Superficie de la casa.
\item $sqftbasement:$ Superficie del sótano, en caso de que posean uno.
\item $yrbuilt:$ Año de construcción.
\item $yrrenovation:$ Año de renovación, en caso de que hubiese.
...
Cabe resaltar que son de los modelos más flexibles ya que también generalizan a los modelos lineales, solo basta que las funciones $h_i$ correspondan a la función identidad y por lo tanto sean todas iguales. \citep{GAM}
...
$$\includegraphics{UVEModelosLineales}$$
\begin{center}
